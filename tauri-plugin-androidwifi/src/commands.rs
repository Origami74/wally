...
#[command]
pub(crate) async fn get_current_wifi_details<R: Runtime>(
    app: AppHandle<R>,
    payload: Empty,
) -> crate::Result<CurrentWifiResponse> {
    app.androidwifi().get_current_wifi_details(payload)
}

#[command]
pub(crate) async fn get_mac_address<R: Runtime>(
    app: AppHandle<R>,
...
#[command]
pub(crate) async fn get_gateway_ip<R: Runtime>(
    app: AppHandle<R>,
    payload: Empty,
) -> crate::Result<GatewayIpResponse> {
    app.androidwifi().get_gateway_ip(payload)
}

#[command]
pub(crate) async fn detect_tollgate<R: Runtime>(
    app: AppHandle<R>,
    payload: Empty,
) -> crate::Result<TollgateDetectionResponse> {
    app.androidwifi().detect_tollgate(payload)
}

#[command]
pub(crate) async fn get_network_status<R: Runtime>(
    app: AppHandle<R>,
    payload: Empty,
